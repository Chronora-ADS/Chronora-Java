...
public class DataInitializer {
    ...
    private void createDefaultServices(UserEntity userCreator) throws Exception {
        ...
        List<ServiceEntity> servicesToCreate = Arrays.asList(
                createService("Manutenção Preventiva de Eletrodomésticos",
                        ...
                        6, ServiceModality.PRESENCIAL, LocalDate.now().plusDays(15),
                ...
                createService("Desentupimento de Pia e Vaso Sanitário",
                        ...
                        4, ServiceModality.PRESENCIAL, LocalDate.now().plusDays(7),
                ...
                createService("Instalação de Tomadas e Interruptores",
                        ...
                        8, ServiceModality.PRESENCIAL, LocalDate.now().plusDays(10),
                ...
                createService("Terapia Cognitivo-Comportamental Online",
                        ...
                        5, ServiceModality.REMOTO, LocalDate.now().plusDays(10),
                ...
                createService("Desenvolvimento de APIs com Spring Boot",
                        ...
                        9, ServiceModality.REMOTO, LocalDate.now().plusDays(12),
    ...
    private ServiceEntity createService(String title, String description, int timeChronos, ServiceModality modality, LocalDate deadline, List<CategoryEntity> categories,
